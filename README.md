# LLM Abstention Study: Prompt Style Effects in RAG

NLP Research Project: LLaMA 3 8B Instruct on SQuAD2.0

## Research Question

Does explicit abstention instruction drive abstention behavior in RAG, or is passage grounding alone sufficient? We compare three prompt styles with varying levels of abstention guidance.

## Experimental Design

Three conditions, all using RAG (passage + question):
...
3. **BASELINE** - No abstention guidance, just passage and question

All conditions receive identical passages and questions. Only the prompt template differs.
...
- README.md
- requirements.txt
- config.py               # All settings and three prompt templates
